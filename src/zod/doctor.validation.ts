...
export const createDoctorServerZodSchema = z.object({
  ...
  specialties: z
    .array(z.uuid("Please select a valid specialty"))
    .min(1, "At least one specialty is required"),
}) satisfies z.ZodType<TCreateDoctorPayload>;
...
export const updateDoctorServerZodSchema = z.object({
  ...
  specialties: z
    ...
    .optional(),
}) satisfies z.ZodType<TUpdateDoctorPayload>;

export type TCreateDoctorFormValues = z.infer<typeof createDoctorFormZodSchema>;
export type TEditDoctorFormValues = z.infer<typeof editDoctorFormZodSchema>;
