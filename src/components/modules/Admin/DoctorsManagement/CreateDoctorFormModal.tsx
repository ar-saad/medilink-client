...
import { createDoctorAction } from "@/app/(dashboardLayout)/admin/dashboard/doctors/_action";
...
const defaultValues: TCreateDoctorFormValues = {
  password: "",
  name: "",
  email: "",
  contactNumber: "",
                    ...
                    return (
                      <div className="space-y-1.5">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            field.handleChange(
                              value as TCreateDoctorFormValues["gender"],
                            );
                            field.handleBlur();
                          }}
                        >
