...
import { getDoctorByIdAction } from "@/app/(dashboardLayout)/admin/dashboard/doctors/_action";
...
import { TDoctor, TDoctorDetails } from "@/types/doctor.types";
...
const getAverageRating = (reviews: TDoctorDetails["reviews"]) => {
