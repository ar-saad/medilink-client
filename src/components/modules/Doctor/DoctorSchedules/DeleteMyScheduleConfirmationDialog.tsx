...
import { deleteMyDoctorScheduleAction } from "@/app/(dashboardLayout)/doctor/dashboard/schedules/_action";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import { TDoctorSchedule } from "@/types/doctorSchedule.types";
...
interface DeleteMyScheduleConfirmationDialogProps {
  ...
  doctorSchedule: TDoctorSchedule | null;
}

const getScheduleLabel = (doctorSchedule: TDoctorSchedule | null) => {
